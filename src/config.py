...
DEFAULTS = {
    ...
    "translator_backend": "argos",  # "argos" (offline), "deepl" (API), "ollama" (local LLM)
    ...
    "russian_only": True,           # only translate/show lines containing Cyrillic
    ...
    "change_threshold": 6.0,        # mean per-pixel diff to consider region "changed"
